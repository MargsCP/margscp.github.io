  ...
  return (
    <div className="container-fluid bg-light ">
      <div className="card mt-4 mb-5">
        <div className="card-body text-center p-3 text-center">Home Page placeholder {window.innerWidth}</div>
      </div>
      <div className="row mb-5">
        <div className="col-md-6 mt-2 border pt-3 ">
          <InlineWidget url="https://calendly.com/carson-brantley"></InlineWidget>
        </div>

        <div className="col-md-6 mt-2 border-top border-end border-bottom pt-3 text-center">
          <iframe
            ...
            height= {window.innerWidth > 768 ? "90%": 500 }
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
